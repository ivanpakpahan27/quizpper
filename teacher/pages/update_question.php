        ...
        <div class="report">
            ...
            <form method="post" action="" class="forms" enctype="multipart/form-data">
                ...
                <select name="category">
                    <option <?php if ($category == "English") {
                                echo "selected='seleccted'";
                            } ?> value="English">English</option>
                    <option <?php if ($category == "Math") {
                                echo "selected='seleccted'";
                ...
                <select name="subject">
                    ...
                    ?>
                            <option <?php if ($subject_db == $subject_id) {
                ...
                <a href="<?php echo SITEURL; ?>teacher/index.php?page=questions"><button type="button" class="btn-delete">Cancel</button></a>
            </form>
            <?php
            if (isset($_POST['submit'])) {
                ...
                $subject_id = $obj->sanitize($conn, $_POST['subject_id']);
                ...
                if ($_FILES['image']['name'] != "") {
                    ...
                    if ($valid_file == false) {
                        ...
                        header('location:' . SITEURL . 'teacher/index.php?page=update_question&id=' . $question_id);
                        die();
                    }
